...
export default function TermsPage() {
  ...
  const { data: pageContent, isLoading } = useQuery({
    queryKey: ["pageContent", "terms"],
    queryFn: async () => {
      if (!actor) return null;
      return actor.getPageContent("terms");
    },
  ...
  return (
    <div className="min-h-[60vh] bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {isLoading ? (
          <div className="space-y-3" data-ocid="terms.loading_state">
            {["a", "b", "c", "d", "e"].map((key, i) => (
              <div
                key={key}
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto leading-relaxed">
              By using EarningBySurfing, you agree to abide by our platform
              rules and affiliate guidelines. Full terms and conditions are
